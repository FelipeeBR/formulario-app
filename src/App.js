      ...
      <div className="container" style={{ maxWidth: '500px' }}>
        ...
        <Form onSubmit={handleSubmit} noValidate>
          <Form.Group className="form-group">
            ...
            <Form.Control type="text" name="nome" className='form-control' value={formData.nome} onChange={handleChange} isInvalid={!!errors.nome}
          ...
          <Form.Group className="form-group">
            ...
            <Form.Control type="email" name="email" className='form-control' value={formData.email} onChange={handleChange} isInvalid={!!errors.email}
          ...
          <Form.Group className="form-group">
            ...
            <Form.Control type="password" name="senha" className='form-control' value={formData.senha} onChange={handleChange} isInvalid={!!errors.senha}
          ...
          <Form.Group className="form-group">
            ...
            <Form.Control type="password" name="confirmarSenha" className='form-control' value={formData.confirmarSenha} onChange={handleChange} isInvalid={!!errors.confirmarSenha}
